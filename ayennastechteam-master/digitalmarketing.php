...
<?php $link="services"; include('menu.php'); ?>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 offset-xl-3">
            <h1 class="pagetitle__heading">Digital Marketing </h1>
            <p class="pagetitle__desc">Whether you
are looking for more website traffic, more
leads, more sales, more social followers,
higher engagement rates, higher email open
rates .Whatever your needs , we get it
done. Guaranteed. </p>
            <a href="contact.php" class="btn btn__primary btn__primary-style2">
        ...
        <div class="row">
          <div class="col-12">
            <nav class="nav nav-tabs justify-content-center">
              ...
              <a href="#" data-scroll="work-process" class="nav__link">How we Work</a>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-7 col-xl-6">
            <div class="heading heading-layout2 mb-50">
              ...
              <p class="heading__desc mb-30">Our vision has led Ayennastechteam to become an
emerging IT company in Nigeria & USA for
delivering various industry-led mobility
solutions. The goal is to empower clients
and businesses by creating new possibilities
leveraging the technologies of today
and tomorrow with the utmost quality,
            ...
            <div class="row">
              <div class="col-sm-6 col-md-6">
                ...
                <div class="feature-item">
                  ...
                  <h4 class="feature__title">SEO Service</h4>
                  <p class="feature__desc">SEO Services also is known as internet marketing is an endeavor to brighten your business prospects’ online...</p>
             <a href="seoservice.php" class="btn btn__primary btn__primary-style2">
              <span>Get Started</span> <i class="icon-arrow-right"></i>
            </a>
                </div><!-- /.feature-item -->
                <!-- Feature item #2 -->
                <div class="feature-item">
                  ...
                  <h4 class="feature__title">PPC Management </h4>
                  <p class="feature__desc">Being effective in PPC Management Services long term depends on proving the return for each dollar spent...</p>
                  <a href="ppc.php" class="btn btn__primary btn__primary-style2">
              <span>Get Started</span> <i class="icon-arrow-right"></i>
            </a>
                </div><!-- /.feature-item -->
                <!-- Feature item #3 -->
              ...
              <div class="col-sm-6 col-md-6">
                ...
                <div class="feature-item">
                  ...
                  <h4 class="feature__title">Social Media </h4>
                  <p class="feature__desc">Social Media Management means managing your all social media profile like
Facebook...</p>
                 <a href="socialmediamanagement.php" class="btn btn__primary btn__primary-style2">
              <span>Get Started</span> <i class="icon-arrow-right"></i>
            </a>
                </div><!-- /.feature-item -->
                <!-- Feature item #5 -->
              ...
              <div class="col-12">
                <div class="cta-banner mt-50 mb-30 d-flex flex-wrap align-items-center">
                  <h4 class="cta__title pr-30">If you have any questions or need help, feel free to contact with
                    our
                    team, or you can call us any time <a href="tel:78100 02536">78100 02536</a>
                  </h4>
          ...
          <div class="col-sm-12 col-md-12 col-lg-5 col-xl-5 offset-xl-1">
            <div class="sticky-top">
              <img src="assets/images/about/1.jpg" alt="banner">
            </div>
          </div><!-- /col-lg-5 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
            ...
            <div class="banners-wrapper sticky-top">
              ...
              <div class="cta-banner mt-30 mb-30 d-flex flex-wrap align-items-center">
                <h4 class="cta__title my-3 pr-30">
                  ...
                  project? Drop us a line or two at: <a href="mailto:contact@Ayennastechteamglobal.com">contact@Ayennastechteamglobal.com</a>
                </h4>
