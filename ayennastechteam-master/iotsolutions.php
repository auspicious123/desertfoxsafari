...
<html lang="en">
  ...
  <meta
    ...
    />
<title> IOT Solutions - Services </title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6 offset-xl-3">
            <h1 class="pagetitle__heading">     IOT Solutions

</h1>
            <p class="pagetitle__desc">18+ Projects Handed over to clients</p>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
            <div class="heading text-center mb-50">
                                                        <h3 class="heading__title">Internet Of things with Ayennastechteam</h3>
                        ...
                        <div class="container">
                            <p class="igx-mb-0">Leveraging the power of Internet of Things (IoT), the network of “Connected Devices”,
Ayennastechteam is the best IoT service provider in developing innovative IoT solutions. 
<br> <br> 
Our IoT experts develop bespoke and innovative IoT solutions to simplify and automate
complex business processes. Together we can create amazing wireless experiences with
the modern IoT hardware to collect information.<br> <br>
Hire the best IoT programmers from
Ayennastechteam who help startups and enterprises to build an IoT platform and connect it
with other cloud, onsite applications or multiple IoT platforms.

</p>
                            <h4>Services we offer at Ayennastechteam?</h4>
                            <ul class="igx-mb-0 igx-col-3">
                                <li>Smart Home Automation
</li>
                                <li>Industrial IoT Automation
</li>
                                <li>IoT Application Development</li>
                                <li>iBeacon Solutions</li>
                                <li>APIs & Backend</li>
                                <li>IoT Cloud Integration
</li>
            ...
            <div class="banners-wrapper sticky-top">
              ...
              <div class="cta-banner mt-30 mb-30 d-flex flex-wrap align-items-center">
                <h4 class="cta__title my-3 pr-30">
                  ...
                  project? Drop us a line or two at: <a href="mailto:Ayennas2019@gmail.com">Ayennas2019@gmail.com</a>
                </h4>
                <a href="requestdemo.php" class="btn btn__primary btn__primary-style2">
